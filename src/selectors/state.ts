...
export const getLectures = (state: RootState) => state.lectures.lectures;
...
export const hasMoreCourses = (state: RootState) => state.courses.hasMore;
export const hasMoreLectures = (state: RootState) => state.lectures.hasMore;
export const hasMorePosts = (state: RootState) => state.posts.hasMore;
export const isLoadingCourses = (state: RootState) => state.courses.isLoading;
export const isLoadingLectures = (state: RootState) => state.lectures.isLoading;
